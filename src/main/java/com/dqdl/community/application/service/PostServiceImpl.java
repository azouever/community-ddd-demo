...
public class PostServiceImpl implements PostService {
  ...
  public PostingRespBody posting(RequestDto<PostingReqBody> requestDto) throws BusinessException {
     ...
     * NOTE：这里的PostAuthor不需要从repository重载，原因在于：posting场景需要用户登录后才能操作，
     * 		在进入service之前，已经在controller层完成了用户身份鉴权，故到达这里的userId肯定是合法的用户
     */
    PostAuthor postAuthor = PostAuthorFactory.createPostAuthor(userIdInLong);
  ...
  @Override
  public DeletePostRespBody delete(RequestDto<DeletePostReqBody> requestDto)
