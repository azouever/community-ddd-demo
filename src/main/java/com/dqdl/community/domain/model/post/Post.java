...
public class Post {
  ...
  public Post(long authorId, String title, String sourceContent) {
    ...
    this.setPostAuthor(PostAuthorFactory.createPostAuthor(authorId));
  }
   ...
   */
  public void filt(PostTitleContentFilterChain titleFilter,
      PostMainBodyContentFilterChain mainBodyfilter) {
